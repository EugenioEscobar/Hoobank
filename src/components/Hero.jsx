...
const Hero = () => {
    return (
        ...
        flex-col ${styles.paddingY} `}>
            ...
            flex-col xl:px-0 sm:px-16 px-6 `}>s
            ...
            <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
                <img src={robot} alt="billing" srcset="" className='w-[100%]
                h-[100%] relative z-[5]' />

                <div className="absolute z-[0] w-[40%] h-[35%] 
                top-0 pink__gradient"></div>
                <div className="absolute z-[1] w-[80%] h-[80%] 
                top-0 rounded bottom-40 white__gradient"></div>
                <div className="absolute z-[2] w-[50%] h-[50%] 
