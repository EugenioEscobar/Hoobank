...
const Testimonials = () => (
    ...
    ${styles.flexCenter} flex-col relative`}>
        ...
        -right-[50%] rounded-full blue__gradient"></div>

        <div className="w-full flex justify-between items-center
        md:flex-row flex-col sm:mb-16 mb-6 realtive z-[1]">
            ...
            <div className="w-full md:mt-0 mt-6">
                <p className={`${styles.paragraph} text-left
                    ...
                    <br className="sm:block hidden" /> and grow your business anywhere on the planet.
                </p>
            </div>
        </div>
